...
export const experiences = [
    {
        ...
        description:
            'Responsible for developing and maintaining a single-page application (SPA) built with React and its core features such as the Player.',
    ...
    },
    {
        ...
        description:
            "Following the acquisition of CHILI Tech's business division by Globant, I persistently contribute to the same projects I previously managed (the streaming platforms CHILI and FIFA+).",
    },
    {
        key: 'chili',
        company: 'CHILI',
        ...
        description:
            "Developed and maintained the streaming company's Website (desktop and mobile) and Smart TV App over several devices (Samsung, LG, Sony, etc).",
    ...
    },
    {
        ...
        description:
            'Developed enterprise web applications for a major insurance corporation. Played a key role as a Frontend Vice-Team Leader.',
