...
export default function BooksPage() {
  ...
  const books = useMemo(
    () => sortBooks(booksData as Book[], DEFAULT_SORT),
    [],
  )
  ...
  const hiddenIds = useMemo(() => {
    ...
    return new Set(
      books
        .filter((b) => !b.category || !activeCats.has(b.category))
        .map((b) => b.id),
    )
  }, [books, activeCats])
  ...
  return (
    <div className="bookcase min-h-screen bg-neutral-50 text-black mt-[88px]">
      <main className="container relative mx-auto overflow-x-hidden px-4 pb-24">
        ...
        <div className="md:relative md:z-10 md:-mt-[13vw] md:flex md:items-start md:gap-6">
          ...
          <div className="relative z-20 mt-5 text-center md:mt-0 md:w-[40%] md:pt-[14.5vw] md:text-left">
            <p className="text-base text-gray-600 md:text-lg">
              Books I&apos;ve read, lined up by spine. Tap one to pull it off the
              shelf.
            </p>
            <div className="mt-5">
              <CategoryFilter
